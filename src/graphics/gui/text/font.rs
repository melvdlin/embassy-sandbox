...
use super::PrintableAsciiMap;
use crate::graphics::gui::format::A8;

pub static FIRA_MONO_16: PrintableAsciiMap<'static, A8> =
    parse_pgm(include_bytes!("font/firamono_16.pgm"), 16, 32..127);
pub static FIRA_MONO_18: PrintableAsciiMap<'static, A8> =
    parse_pgm(include_bytes!("font/firamono_18.pgm"), 18, 32..127);
pub static FIRA_MONO_24: PrintableAsciiMap<'static, A8> =
    parse_pgm(include_bytes!("font/firamono_24.pgm"), 24, 32..127);
pub static FIRA_MONO_28: PrintableAsciiMap<'static, A8> =
    parse_pgm(include_bytes!("font/firamono_28.pgm"), 28, 32..127);
pub static FIRA_MONO_32: PrintableAsciiMap<'static, A8> =
    parse_pgm(include_bytes!("font/firamono_32.pgm"), 32, 32..127);
pub static FIRA_MONO_40: PrintableAsciiMap<'static, A8> =
    parse_pgm(include_bytes!("font/firamono_40.pgm"), 40, 32..127);
pub static FIRA_MONO_48: PrintableAsciiMap<'static, A8> =
    parse_pgm(include_bytes!("font/firamono_48.pgm"), 48, 32..127);
pub static FIRA_MONO_56: PrintableAsciiMap<'static, A8> =
    parse_pgm(include_bytes!("font/firamono_56.pgm"), 56, 32..127);
pub static FIRA_MONO_64: PrintableAsciiMap<'static, A8> =
...
const fn parse_pgm(
    ...
    PrintableAsciiMap::new(mapped_chars, width, char_height, chars, fallback)
}
